 ...
 *
 */
export declare function randCreditCard<Options extends CreditCardOptions = never>(options?: Options): [Options] extends [never] ? CreditCard : Options["length"] extends number ? CreditCard[] : CreditCard;
