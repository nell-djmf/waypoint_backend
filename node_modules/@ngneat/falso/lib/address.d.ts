 ...
 *
 */
export declare function randAddress<Options extends AddressOptions = never>(options?: Options): [Options] extends [never] ? Address : Options["length"] extends number ? Address[] : Address;
