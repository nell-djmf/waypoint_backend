 ...
 *
 */
export declare function randCodeSnippet<Options extends CodeSnippetOptions = never>(options?: Options): [Options] extends [never] ? string : Options["length"] extends number ? string[] : string;
export {};
