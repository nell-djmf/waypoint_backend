 ...
 *
 */
export declare function randBic<Options extends SwiftOptions = never>(options?: Options): [Options] extends [never] ? string : Options["length"] extends number ? string[] : string;
