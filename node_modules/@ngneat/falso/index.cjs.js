...
function fake(data, options) {
  ...
  if ((options === null || options === void 0 ? void 0 : options.length) === undefined) {
    return dataSource(0);
  }
...
function randIban(options) {
  ...
  if ((options === null || options === void 0 ? void 0 : options.countryCode) && ((_a = options === null || options === void 0 ? void 0 : options.countryCode) === null || _a === void 0 ? void 0 : _a.length) !== 2) {
  ...
  var factory = function factory() {
    ...
    var countryCode = (_a = options === null || options === void 0 ? void 0 : options.countryCode) !== null && _a !== void 0 ? _a : randCountryCode();
    var checkDigits = randNumber({
      min: 10,
      max: 99
    }).toString();
    var bban = Array(randNumber({
      min: 12,
      max: 30
    })).fill('#').join('').replace(/#/g, function () {
